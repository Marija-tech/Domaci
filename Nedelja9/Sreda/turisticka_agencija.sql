...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2021 at 01:36 PM
...
ALTER TABLE `putovanja`
  ADD PRIMARY KEY (`destinacija_id`),
  ADD KEY `id` (`id`);
...
--
ALTER TABLE `destinacije`
  ADD CONSTRAINT `destinacije_ibfk_1` FOREIGN KEY (`id`) REFERENCES `putovanja` (`destinacija_id`);

--
-- Constraints for table `putovanja`
--
ALTER TABLE `putovanja`
  ADD CONSTRAINT `putovanja_ibfk_1` FOREIGN KEY (`id`) REFERENCES `spisak_putnika` (`id_putovanja`);
